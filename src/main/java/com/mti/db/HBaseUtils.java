...
public class HBaseUtils {
    ...
    private final TableName tablaTweets = TableName.valueOf("TWEETS");
    private final String tweetDataColumnFamily = "tweet_data";
    ...
    public void filters(Table table) throws IOException {
    ...
    public void get(Table table) throws IOException {
    ...
    public void putTweetsCuenta(Configuration config, Cuenta cuenta, List<Status> status ) throws IOException {
        ...
        try (Connection connection = ConnectionFactory.createConnection(config)) {
            ...
            Table table = connection.getTable(tablaTweets);
            Put p = null;
